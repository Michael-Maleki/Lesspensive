			...
			<div className='columns-box'>
				...
				<div className='columns'>
					...
					<div className='columns__bedrooms'>
						...
						<Link className='more' to='bedrooms'><img className='dotdotdot' src={dots}/>More</Link>
					</div>
					...
					<div className='columns__livingrooms'>
						...
						<Link className='more' to='living-rooms'><img className='dotdotdot' src={dots}/>More</Link>
					...
					<div className='columns__diningrooms'>
						...
						<Link className='more' to='dining-rooms'><img className='dotdotdot' src={dots}/>More</Link>
					</div>
